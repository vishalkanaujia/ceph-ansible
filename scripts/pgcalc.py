...
def populate(args):
	...
	if(minValue>calcValue):
		if args[7] == "replicated":
			print "ceph osd pool create {} {} {}_ruleset_{};ceph osd pool set {} size {};ceph osd pool set {} min_size {};sleep 1;".format(args[5],int(minValue),args[7],args[6],args[5],args[2],args[5],args[8])
		...
		if args[7] == "replicated":
			print "ceph osd pool create {} {} {}_ruleset_{};ceph osd pool set {} size {};ceph osd pool set {} min_size {};sleep 1;".format(args[5],int(calcValue),args[7],args[6],args[5],args[2],args[5],args[8])
		if args[7] == "erasurecoded":
